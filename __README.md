...
### Instruções
- Entre no diretorio da aplicação através do terminal
- Execute o comando php -S localhost:8080 em seu terminal
- Acesse através do navegador o endereço localhost:8080
- Detalhes sobre a aplicação e as páginas estão contidas através da página "Instruções" (http://localhost:8080/instructions.php)
